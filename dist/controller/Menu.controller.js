sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.etiMaden.controller.Menu", {
		...
		_onButtonPress1: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.oRouter.navTo("OrderPage",{email : email,soyad : soyad},false);
		...
		_onButtonPress2: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("UnderConstruction", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}
		...
		_onButtonPress4: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				this.oRouter.navTo("InfoPage",{email : email,soyad : soyad},false);
		...
		_onButtonPress5: function(oEvent) {
			...
			return new Promise(function(fnResolve) {
				...
				this.doNavigate("BasketPage", oBindingContext, fnResolve, "");
			}.bind(this)).catch(function(err) {
				if (err !== undefined) {
					MessageBox.error(err.message);
				}

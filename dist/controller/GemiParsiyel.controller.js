...
var email,markalama,ilaclama,gozetmen,aciklamaasil="",s=1,newData = [];
    return BaseController.extend("com.sap.build.standard.etiMaden.controller.GemiParsiyel", {
		handleRouteMatched: function(oEvent) {
			var sAppId = "App5f4a50eed8186865e233a390";
			...
			this.aRadioButtonGroupIds = ["sap_Wizard_Page_0-content-sap_m_Wizard-1-steps-sap_m_WizardStep-1598849215782-content-build_simple_form_Form-1598852863156-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-1-fields-sap_m_RadioButtonGroup-1598853112632", "sap_Wizard_Page_0-content-sap_m_Wizard-1-steps-sap_m_WizardStep-1598849215782-content-build_simple_form_Form-1598852863156-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-2-fields-sap_m_RadioButtonGroup-1598853107345", "sap_Wizard_Page_0-content-sap_m_Wizard-1-steps-sap_m_WizardStep-1598849215782-content-build_simple_form_Form-1598852863156-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-3-fields-sap_m_RadioButtonGroup-1598853071280"];
		...
		_onWizardComplete: function(oEvent) {
			...
			jQuery.ajax({
				...
				this.oRouter.navTo("OzetEkrani",{email : email},false);
				}		
		...
		convertTextToIndexFormatter: function(sTextValue) {
			var oRadioButtonGroup = this.byId("sap_Wizard_Page_0-content-sap_m_Wizard-1-steps-sap_m_WizardStep-1598849215782-content-build_simple_form_Form-1598852863156-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-1-fields-sap_m_RadioButtonGroup-1598853112632");
		...
		convertTextToIndexFormatter1: function(sTextValue) {
			var oRadioButtonGroup = this.byId("sap_Wizard_Page_0-content-sap_m_Wizard-1-steps-sap_m_WizardStep-1598849215782-content-build_simple_form_Form-1598852863156-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-2-fields-sap_m_RadioButtonGroup-1598853107345");
			var oButtonsBindingInfo = oRadioButtonGroup.getBindingInfo("buttons");
			if (oButtonsBindingInfo && oButtonsBindingInfo.binding) {
				// look up index in bound context
				var sTextBindingPath = oButtonsBindingInfo.template.getBindingPath("text");
		...
		convertTextToIndexFormatter2: function(sTextValue) {
			var oRadioButtonGroup = this.byId("sap_Wizard_Page_0-content-sap_m_Wizard-1-steps-sap_m_WizardStep-1598849215782-content-build_simple_form_Form-1598852863156-formContainers-build_simple_form_FormContainer-1-formElements-build_simple_form_FormElement-3-fields-sap_m_RadioButtonGroup-1598853071280");
			var oButtonsBindingInfo = oRadioButtonGroup.getBindingInfo("buttons");
			if (oButtonsBindingInfo && oButtonsBindingInfo.binding) {
				// look up index in bound context
				var sTextBindingPath = oButtonsBindingInfo.template.getBindingPath("text");
		...
		onInit: function() {
			...
			this.oRouter.getTarget("GemiParsiyel").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));

sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	var email,konteyner,data,newData = []; 
		return BaseController.extend("com.sap.build.standard.etiMaden.controller.OzetEkrani", {
		...
		_onEditButtonPress: function(oEvent) {
			...
			var oBindingContext = oEvent.getSource().getBindingContext();	
				...
				this.oRouter.navTo("GemiParsiyel",{email : email},false);
		...
		onInit: function() {
			...
			this.oRouter.getTarget("OzetEkrani").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
